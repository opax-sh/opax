...
The SDK includes `opax init --test-platform` which verifies remote platform compatibility and configures Opax-owned explicit push/fetch refspecs accordingly.
